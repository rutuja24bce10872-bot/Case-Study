...
```bash
git clone https://github.com/Xylarian/oss-audit-24BCE10872.git
cd oss-audit-24BCE10872
```
...
All scripts in this repository are original work written by Rutuja Patil, 24BCE10872. All comments and logic are the author's own. Scripts are designed to run on real Linux systems and demonstrate genuine understanding of shell scripting concepts as required by the Open Source Software course rubric.
